...
export default class LeftMenu extends Component {
    ...
    render() {
        return (
            <div>
                <Menu theme={this.state.theme} defaultSelectedKeys={['/']} defaultOpenKeys={['sub1']} mode="inline">
                    <Menu.Item key="/">
                        <Link to="/">
                            <Icon type="home"/>
                            <span>首页</span>
                    ...
                    <SubMenu key="sub1" title={<span><Icon type="mail" /><span>信息展示</span></span>}>
                        <MenuItemGroup key="g1" title="个人信息">
                            <Menu.Item key="1"><Link to="/stars-info">GiHub收藏项目</Link></Menu.Item>
                            <Menu.Item key="2">Option 2</Menu.Item>
                        </MenuItemGroup>
                        <MenuItemGroup key="g2" title="其他用户信息">
